...
export const AdminLand = () => {
  const buttons = [
    { icon: <AddToPhotosIcon sx={{ fontSize: 40 }} />, text: "View Pending Organisations and Donors",
    link:'/Pending_accounts'
  },
    {
      icon: <ManageSearchIcon sx={{ fontSize: 40 }} />,
      text: "Manage Organisations and Donors Requests",
      link:'/Manage_requests'
    },
    {
      ...
      {
        icon: <ViewCarouselIcon sx={{ fontSize: 40 }} />,
        text: "View Registered Organisations & Donors",
        link:'/Registered_users'
      },
  ];
